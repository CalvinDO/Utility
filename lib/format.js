...
(function (Format) {
    ...
    function init(_event) {
        var _a;
        displayParagraph = document.querySelector("p");
        ...
        button.addEventListener("click", function handleClick(event) {
            ...
            console.log(concatArray(Array.from(extractLinesFromTextNode(displayParagraph.firstChild))));
            document.querySelector("div").innerHTML = concatArray(Array.from(extractLinesFromTextNode(displayParagraph.firstChild)));
        });
    }
